...
import { SendNotificationUseCase, SendNotificationUseCaseRequest, SendNotificationUseCaseRequestResponse } from "../use-case/send-notification";
...
describe("On Answer Created", () => {
  ...
  it("should be send a notification when a an answer is created", async () => {
